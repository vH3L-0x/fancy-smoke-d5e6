...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/fancy-smoke-d5e6
```

A live public deployment of this template is available at [https://fancy-smoke-d5e6.templates.workers.dev](https://fancy-smoke-d5e6.templates.workers.dev)
